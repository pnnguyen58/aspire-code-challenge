...
CREATE USER aspire WITH ENCRYPTED PASSWORD '1qazxsw23edc';
...
-- Grant permission
GRANT CONNECT ON DATABASE code_challenge TO aspire;
GRANT USAGE ON SCHEMA public TO aspire;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO aspire;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO aspire;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO aspire;
